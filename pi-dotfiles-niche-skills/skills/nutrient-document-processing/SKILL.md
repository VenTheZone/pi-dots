...
## MCP Server (Optional Alternative)

Pi has no built-in MCP support. Use the curl workflow above by default. If you already use an MCP extension in pi, you can wire the Nutrient MCP server like this:
