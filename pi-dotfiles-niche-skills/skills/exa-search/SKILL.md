...
result = deep_researcher_check(researchId: "<id from start>")
```
...
# ... later ...
results = deep_researcher_check(researchId: "<id>")
```
...
- `external-scout-and-plan` — External research + implementation planning (uses exa-search)
