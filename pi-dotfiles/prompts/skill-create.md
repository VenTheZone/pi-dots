...
Analyze git history to generate reusable pi-compatible skills: $ARGUMENTS
...
4. **Package reusable workflows** - Structure the output as portable pi skills and supporting docs
